...
var ServerInformation = {
	POIDATA_SERVER: "http://merahputihbridge.com/webservice/ar_service.php",
...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
			var singlePoi = {
				...
				"pict": poiData[currentPlaceNr].pict
			};
		...
		World.updateStatusMessage(currentPlaceNr + ' lokasi terdeteksi');
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
		...
		$("#poi-detail-pict").html("<img src='"+marker.poiData.pict+"'/>");
	...
	updateRangeValues: function updateRangeValuesFn() {
		...
		$("#panel-distance-places").html((placesInRange != 1) ? (placesInRange + " Tempat wisata") : (placesInRange + " Tempat wisata"));
	...
	requestDataFromServer: function requestDataFromServerFn(lat, lon) {
		...
		World.updateStatusMessage('Meminta data lokasi dari web-service');
